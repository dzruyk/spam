...
typedef void (*list_pass_cb)(struct list_item *item);
...
void list_add(struct list *root, struct list_item *item);

/* add new item in list(to end of list */
void list_add_to_end(struct list *root, struct list_item *item);

/* return first element of list, NULL otherwise */
struct list_item *list_get_first(struct list *root);

/* return n element of list, NULL otherwise */
struct list_item *list_get_n(struct list *root, unsigned int n);
 ...
 */
int list_pass(struct list *root, list_pass_cb func);
