...
map <C-S-Left> :tabp
map <C-S-Right> :tabn
map <S-F10> :call HlSpace()
map <S-F11> :call ToggleNum()
map <S-F12> :call ChangeBg()
map <F5> :!ctags -R --c-kinds=+l --fields=+iaS --extra=+q ./:set tags+=tags
...
set ignorecase
set incsearch
set langmap=йq,цw,уe,кr,еt,нy,гu,шi,щo,зp,фa,ыs,вd,аf,пg,��h,оj,лk,дl,яz,чx,сc,мv,иb,тn,ьm,ЙQ,ЦW,УE,КR,ЕT,НY,ГU,ШI,ЩO,ЗP,ФA,ЫS,ВD,АF,ПG,РH,ОJ,��K,ДL,ЯZ,ЧX,СC,МV,ИB,ТN,ЬM,х[,Х{,ъ],ж\\;,Ж:,э',Э\",б\\,,Б<,ю.,Ю>,Ё~
...
exe 'vert 3resize ' . ((&columns * 144 + 88) / 176)
argglobal
enew
file NERD_tree_1
let s:cpo_save=&cpo
...
setlocal wrap
setlocal wrapmargin=0
let s:l = 28 - ((22 * winheight(0) + 11) / 23)
...
setlocal wrap
setlocal wrapmargin=0
let s:l = 40 - ((0 * winheight(0) + 11) / 22)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
40
